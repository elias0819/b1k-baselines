        ...
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform(
                    ...
                    passthrough_keys=("episode_index",),
                )
            ]
        )
...
class TrainConfig:
    ...
    # Optional VLAC weight file for per-episode weighting.
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotB1KDataConfig(
            ...
            base_config=DataConfig(
                prompt_from_task=True,
                # episodes_index=list(range(190)),
                behavior_dataset_root="/mnt/lihaoyu/upload/BEHAVIOR-1K/DATASETS/behavior-1k/2025-challenge-demos",
            ),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/Data-public/wxq/checkpoint/pi05_base/params"),
        ...
        # val_repo_id="behavior-1k/2025-challenge-demos",
        # val_episodes_index=list(range(190, 200)),
        assets_base_dir="/mnt/lihaoyu/workdir/openpi/outputs/assets",
        checkpoint_base_dir="/mnt/lihaoyu/workdir/openpi/outputs/checkpoints",
        num_workers=0,
        resume=True,
    ),
    
    # TrainConfig(
    #     name="pi05_b1k_sub_task_00",
    #     exp_name="openpi",
    #     project_name="B1K",
    #     model=pi0_config.Pi0Config(pi05=True, action_horizon=50),
    #     data=LeRobotB1KDataConfig(
    ...
    #             prompt_from_task=True,
    #             # episodes_index=list(range(190)),
    #             behavior_dataset_root="/mnt/Data-public/lihaoyu/dataset/behavior-1k/2025-challenge-demos",
    #         ),
    #     ),
    #     weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/Data-public/wxq/checkpoint/pi05_base/params"),
    #     num_train_steps=60_000,
    ...
    TrainConfig(
        name="pi05_b1k_sub_task_00",
        exp_name="openpi_lerobot_dataset",
        project_name="B1K",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=50),
        data=LeRobotB1KDataConfig(
            repo_id="behavior-1k/lerobot_sub_dataset",
            assets=AssetsConfig(
                assets_dir="/mnt/lihaoyu/workdir/openpi/outputs/assets/pi05_b1k_sub_task_00",
                asset_id="behavior-1k/2025-challenge-demos",
            ),
            base_config=DataConfig(
                prompt_from_task=True,
                behavior_dataset_root="/mnt/Data-public/lihaoyu/dataset/behavior-1k/lerobot_sub_dataset",
            ),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("/mnt/Data-public/wxq/checkpoint/pi05_base/params"),
        num_train_steps=60_000,
    ...
    TrainConfig(
        name="pi05_b1k_picking_up_trash",
        exp_name="openpi_picking_up_trash",
        project_name="B1K",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=50),
        data=LeRobotB1KDataConfig(
            repo_id="behavior-1k/2025-challenge-demos",
    ...
    TrainConfig(
        ...
        data=LeRobotB1KDataConfig(
            repo_id="behavior-1k/2025-challenge-demos",
            #repo_id="behavior-1k/turning_on_radio_sub_task_100",
            base_config=DataConfig(
                prompt_from_task=True,
                behavior_dataset_root="/mnt/lidongze/upload/behavior-1k/2025-challenge-demos",
                #behavior_dataset_root="/mnt/lidongze/upload/datasets/behavior-1k/turning_on_radio_sub_task_100",
            ),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "/mnt/lidongze/upload/checkpoints/pi05_base/params"
        ),
